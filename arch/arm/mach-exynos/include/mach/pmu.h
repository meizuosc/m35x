...
extern void exynos_xxti_sys_powerdown_enable(bool mode);
...
#else
static void inline exynos_enable_idle_clock_down(unsigned int cluster) { };
static void inline exynos_disable_idle_clock_down(unsigned int cluster) { };
#endif
