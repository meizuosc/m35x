...
static int exynos5_mmc_clock_init(void)
{
	...
	dw_mmc0 = clk_get_sys("dw_mmc0", "sclk_dwmci");
	dw_mmc1 = clk_get_sys("dw_mmc1", "sclk_dwmci");
	dw_mmc2 = clk_get_sys("dw_mmc2", "sclk_dwmci");
...
void __init exynos5_tf4_clock_init(void)
{
