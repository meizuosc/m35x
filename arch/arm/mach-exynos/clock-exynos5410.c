...
static void __init tf4_pll_init(void)
{
...
static struct sleep_save exynos5410_sclk_isp_sensor_save[] = {
	SAVE_ITEM(EXYNOS5_SCLK_DIV_ISP1),
...
static int exynos5_vpll_ctrl(struct clk *clk, int enable)
{
	...
	ret = s5p_gatectrl(EXYNOS5_VPLL_CON2, clk, !enable);
...
/* Possible clock sources for aclk_300_disp0_sub Mux */
static struct clk *clk_src_disp0_300_list[] = {
	[0] = &clk_ext_xtal_mux,
	[1] = &exynos5_clk_dout_aclk_300_disp0.clk,
};

static struct clksrc_sources clk_src_disp0_300 = {
	.sources	= clk_src_disp0_300_list,
	.nr_sources	= ARRAY_SIZE(clk_src_disp0_300_list),
};

static struct clksrc_clk exynos5_clk_aclk_300_disp0 = {
	.clk	= {
		.name		= "aclk_300_disp0",
		.enable		= exynos5_clk_src_ctrl,
	},
	.sources = &clk_src_disp0_300,
	.reg_src = { .reg = EXYNOS5_CLKSRC_TOP3, .shift = 18, .size = 1 },
};
...
/* Dummy source - Prevent printing 'bad source 0'*/
...
/* SPI3 : SPI0_ISP */
static struct clksrc_clk exynos5_clk_dout_spi3 = {
	.clk		= {
		.name		= "dout_spi3",
	},
	.sources = &exynos5_clkset_group,
...
static struct clksrc_clk exynos5_clk_sclk_spi3 = {
	.clk	= {
		.name		= "sclk_spi",
		.devname	= "s3c64xx-spi.3",
		.parent		= &exynos5_clk_dout_spi3.clk,
	},
...
static struct pll_div_data exynos5_dpll_div[] = {
	...
	{780000000, 4, 260, 1, 0,  0, 0},
	{750000000, 4, 250, 1, 0,  0, 0},
	{720000000, 4, 240, 1, 0,  0, 0},
...
static int exynos5410_clock_suspend(void)
{
	...
	s3c_pm_do_save(exynos5410_sclk_isp_sensor_save,
		ARRAY_SIZE(exynos5410_sclk_isp_sensor_save));
	return 0;
}
...
static void exynos5410_clock_resume(void)
{
	...
	s3c_pm_do_restore_core(exynos5410_sclk_isp_sensor_save,
		ARRAY_SIZE(exynos5410_sclk_isp_sensor_save));
...
void __init exynos5410_register_clocks(void)
{
	...
	// we need 32k clk for WIFI
	do {
		unsigned int rtc_con;
		rtc_con = readw(S3C_VA_RTC + S3C2410_RTCCON);
		writew(rtc_con | S3C2410_RTCCON_CLKOUTEN, S3C_VA_RTC + S3C2410_RTCCON);
	} while (0);
#endif
}
