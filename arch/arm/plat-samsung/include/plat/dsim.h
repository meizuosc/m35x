...
struct mipi_dsim_lcd_driver {
	...
	int	(*read_id)(struct mipi_dsim_device *dsim);
	int	(*read_information)(struct mipi_dsim_device *dsim);
	int	(*remove)(struct mipi_dsim_device *dsim);
	int	(*shutdown)(struct mipi_dsim_device *dsim);
    int (*gopsr)(struct mipi_dsim_device *dsim, int mode);
#endif
};
