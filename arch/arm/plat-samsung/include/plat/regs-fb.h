...
// I80IFCON
#define I80IFCONA_RSPOL_LOW         (0x0 << 2)	
#define I80IFCONA_RSPOL_HIGH        (0x1 << 2)	
#define I80IFCONA_DISABLE			(0x0 << 0)
#define I80IFCONA_ENABLE			(0x1 << 0)

#define I80IFCONB_NORMAL_CMD_ST                 (0x1 << 9)
