...
#elif defined(CONFIG_LCD_MIPI_MEIZU)
extern struct mipi_dsim_lcd_driver meizu_mipi_lcd_driver;
#endif
...
extern int s5p_mipi_dsi_clk_enable_by_fimd(struct device *dsim_device);
extern int s5p_mipi_dsi_clk_disable_by_fimd(struct device *dsim_device);
