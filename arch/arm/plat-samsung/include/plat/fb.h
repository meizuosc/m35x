...
struct s3c_fb_platdata {
	...
	void	(*lcd_off)(void);
	int	(*dsim_on)(struct device *);
	int	(*dsim_off)(struct device *);
	int	(*dsim_clk_on)(struct device *);
	int	(*dsim_clk_off)(struct device *);
	void	(*dp_exit)(void);
 ...
 * @clk_rate: clock rate for parent clock
 */
extern int __init exynos5_fimd0_setup_clock(struct device *dev, const char *bus_clk,
					const char *parent, unsigned long clk_rate);
