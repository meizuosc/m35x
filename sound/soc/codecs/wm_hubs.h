...
typedef void (*wm_hubs_clk_force)(struct snd_soc_codec *codec, bool ena);

/* This *must* be the first element of the codec->private_data struct */
struct wm_hubs_data {
	bool dcs_dev_cal_done;
	...
	struct work_struct dcs_cal_work;
...
extern void wm_hubs_can_calibrate_dcs(struct snd_soc_codec *codec,
				      wm_hubs_clk_force clk_force);
