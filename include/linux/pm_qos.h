...
/* FIXME: The current maximum cpu freq of exynos5410 used is 1.6G, without this
 * change, it's not possible to add a new max_cpu_qos to lock maximum value. */
#define PM_QOS_CPU_FREQ_MAX_DEFAULT_VALUE	1600000
