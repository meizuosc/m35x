...
#define FRAMEMGR_ID_SENSOR	0x0100
#define FRAMEMGR_ID_ISP_GRP	0x0200
#define FRAMEMGR_ID_SCC		0x0400
#define FRAMEMGR_ID_DIS		0x0800
#define FRAMEMGR_ID_DIS_GRP	0x2000
#define FRAMEMGR_ID_SCP		0x1000
...
struct fimc_is_frame_shot {
	...
	enum fimc_is_frame_output dis_out;
