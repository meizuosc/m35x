...
#include "../../../arch/arm/mach-exynos/board-tf4.h"
...
static const struct s2mps11_voltage_desc *reg_voltage_map[] = {
	...
	[S2MPS11_BUCK7] = &buck_voltage_val2,
	[S2MPS11_BUCK8] = &buck_voltage_val2,
	[S2MPS11_BUCK9] = &buck_voltage_val2,
	[S2MPS11_BUCK10] = &buck_voltage_val2,
	[S2MPS11_AP_EN32KHZ] = NULL,
	[S2MPS11_CP_EN32KHZ] = NULL,
	[S2MPS11_BT_EN32KHZ] = NULL,
};
...
//NORMAL, LPA, STANDBY
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO1,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO2,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO3,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO4,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO5,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO6,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO7,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO8,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO9,      
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO10,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO11,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO12,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO13,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO14,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO15,     
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO16,  /* not used */
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO17,     
	{0x3, 0x2, 0x0},            //	S2MPS11_LDO18,  // EMMC_1v8, Output on/off by LDO18EN
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO19,  // TFLASH_2v8 output on/off by LDO 19EN  /* not used */
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO20,
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO21,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO22,     
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO23,  /* not used */
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO24,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO25,  
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO26,  /* not used */    
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO27,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO28,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO29,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO30,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO31, 
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO32,     
	{0x0, 0x0, 0x0},            //	S2MPS11_LDO33,  /* not used */    
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO34,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO35,     
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO36,  
	{0x3, 0x2, 0x1},            //	S2MPS11_LDO37,
	{0x2, 0x2, 0x1},            //	S2MPS11_LDO38,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK1,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK2,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK3,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK4,     
	{0x3, 0x2, 0x1},            //	S2MPS11_BUCK5,     
	{0x3, 0x1, 0x1},            //  S2MPS11_BUCK5V123,
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK6,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK7,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK8,     
	{0x3, 0x1, 0x1},            //	S2MPS11_BUCK9,     
	{0x3, 0x0, 0x0},            //	S2MPS11_BUCK10,    
	{0x1, 0x0, 0x0},            //	S2MPS11_AP_EN32KHZ,
	{0x1, 0x0, 0x0},            //	S2MPS11_CP_EN32KHZ,
	{0x1, 0x0, 0x0},            //	S2MPS11_BT_EN32KHZ,
};
	...
	int *reg, int *pmic_en)
{
	...
	case S2MPS11_BUCK5V123:
		...
		*pmic_en = 0x01 << S2MPS11_PMIC_EN_B5V1_SHIFT |
		0x01 << S2MPS11_PMIC_EN_B5V2_SHIFT |
		0x01 << S2MPS11_PMIC_EN_B5V3_SHIFT;
		return 0;
		break;
...
extern enum board_version_type get_board_version(void);
...
static __devinit int s2mps11_pmic_probe(struct platform_device *pdev)
{
	...
	sec_reg_read(s2mps11->iodev, S2MPS11_REG_RTC_CTRL, &val);
	if(ret)
		return ret;
	val = val | 0x1 | 0x4; //0x1 for AP 32k, 0x2 for codec, 0x4 for Bluetooth
	sec_reg_update(s2mps11->iodev, S2MPS11_REG_RTC_CTRL, val, 0xFF); 
		...
		if(1)
		{
			...
			regulator = regulator_get(NULL, "vdd18_mcu");
			if (!IS_ERR(regulator)) {
				...
				s3c_gpio_setpull(MEIZU_MCU_RST, S3C_GPIO_PULL_UP);
				s3c_gpio_cfgpin(MEIZU_MCU_RST, S3C_GPIO_INPUT);
			}
			else
			{
				dev_err(s2mps11->dev, "failed to get regulator (0x%p).\n",regulator);
			}
		}
#endif
